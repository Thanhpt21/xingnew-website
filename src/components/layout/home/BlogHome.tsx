...
const BlogErrorFallback = () => (
  <div className="text-center py-8 sm:py-10 md:py-12 px-4">
    ...
    <Button 
      ...
      className="border-gray-300 hover:border-gray-500 text-gray-700 hover:text-gray-900 h-9 sm:h-10 text-sm sm:text-base"
    >
      Thử lại
    </Button>
  </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          <div className="mb-4 sm:mb-0">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 py-1 sm:px-3 sm:py-1 bg-gray-100 rounded-full mb-2 sm:mb-3 border border-gray-200">
              <FireOutlined className="text-gray-700 text-xs sm:text-sm" />
              <span className="text-xs sm:text-sm font-medium text-gray-700">MỚI CẬP NHẬT</span>
            </div>
          ...
          <Link 
            href="/tin-tuc" 
            className="group hidden sm:inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 bg-gray-800 text-white text-sm font-semibold rounded-lg hover:bg-gray-900 transition-all duration-300 hover:shadow-lg"
          >
        ...
        <div className="mt-6 sm:mt-8 md:mt-10 text-center sm:hidden">
          <Link 
            href="/tin-tuc" 
            className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-gray-800 text-white text-sm font-semibold rounded-lg hover:bg-gray-900 transition-colors w-full justify-center"
          >
